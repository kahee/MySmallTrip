    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metting_Place', models.CharField(max_length=100, verbose_name='만남장소')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_datetime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='생성시간')),
                ('modify_datetime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='수정시간')),
                ('img_field', models.ImageField(upload_to='product', verbose_name='상품이미지')),
                ('travel_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='travel.TravelInformation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(auto_now_add=True, verbose_name='여행끝날짜')),
