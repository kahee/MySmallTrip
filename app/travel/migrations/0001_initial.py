    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_title', models.TextField(blank=True, null=True, verbose_name='상품설명제목')),
                ('description', models.TextField(blank=True, verbose_name='상품설명')),
                ('meeting_time', models.CharField(blank=True, max_length=100, verbose_name='만남시간')),
                ('meeting_place', models.CharField(blank=True, max_length=100, verbose_name='만남장소')),
                ('price', models.IntegerField(default=0, verbose_name='상품금액')),
                ('price_descrption', models.TextField(blank=True, verbose_name='상품금액 포함사항')),
                ('max_people', models.IntegerField(default=0, verbose_name='최대 사람 수')),
                ('main_image', models.ImageField(upload_to='main_image', verbose_name='대표이미지')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('travel_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='travel_info', to='travel.TravelInformation', verbose_name='travel_info')),
